...
public class ConnectionPool {
    ...
    private static String url = "jdbc:mysql://localhost:3306/testbd";
    private static String user = "root";
    private static String password = "Aa7700noNOno";
    ...
    public static void returnConnection(Connection con){
        ...
        //System.out.println("Returning Connection, pool size = " + connectionQueue.size());
    }
